        ...
        <div class="container">
            <div class="row">
                <div class="left-text col-lg-6 col-md-6 col-sm-12 col-xs-12" data-scroll-reveal="enter left move 30px over 0.6s after 0.4s">
                    ...
                    <a class="main-button-slider" style="cursor:pointer;color:white;width: 120px;display: inline-block;text-align: center;"  data-toggle="modal" data-target="#login">Login</a>
                </div>
